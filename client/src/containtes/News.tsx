...
const texts = {
  "1": {
    ...
    "4": {
      ...
      "text": "Monitoruj swój rozwój zarówno na serwerze SCP, jak i na Discordzie. Aby śledzić swoje osiągnięcia i statystyki, musisz zarejestrować konto na naszej stronie.",
      "img": [
        '../../assets/grafiki/4.png',
        '../../assets/grafiki/5.png',
        '../../assets/grafiki/6.png'
  ...
  return (
    ...
    <section id="news" className=" flex flex-col h-full  pt-[120px] pb-[120px]">
      ...
      <div className="pb-[49px] px-6 sm:px-[40px] lg:px-[80px]">
            ...
            <p className="text-white text-[16px] leading-[26px] font-roboto text-center lg:text-left">Nieobecność serwera przez ostatnie dwa lata, nie oznacza, że nie pracowaliśmy nad nowościami - Odkryj je już dziś!</p>
        </div>
