...
const Dashboard = () => {
  ...
  return (
    <div className="text-white flex flex-col w-full px-6 sm:px-[40px] lg:px-[80px] gap-[33px]">
      ...
      <h3 className="text-[24px] leading-[32px] font-roboto text-center p-6">Zapoznaj się ze swoimi statystykami na naszych serwerach klikając Przegląd na górze strony i wybierając sekcję, która cię interesuje.</h3>
    </div>
  )
}
