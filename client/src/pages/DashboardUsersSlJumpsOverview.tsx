...
import { UsersSLJumpsTopChart } from "../charts";
      ...
      (
        ...
        <div>
          ...
          <div className="flex flex-col sm:flex-row gap-[33px] justify-between w-full">
            ...
            <h2 className="text-[25px] leading-[28px] font-black sm:text-[32px] sm:leading-[32px] lg:text-[40px] lg:leading-[48px] pb-6 sm:pb-[40px]">Króliki:</h2>
            <div className="flex justify-between">
              ...
              <h3 className="text-[24px] leading-[32px] font-roboto font-black uppercase pb-6">Wartość</h3>
                ...
                <UsersSLJumpsTopChart usersSlOverview={usersSlOverview} period={period}/>
            </div>
